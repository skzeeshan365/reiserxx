...
class StaticViewSitemap(Sitemap):
    def items(self):
        return ['home', 'contact', 'search', 'category', 'about', 'subscribe', 'policy', 'stable_diffusion', 'tag_generation', 'summary_generation', 'text_generation', 'transcription']  # Add the names of your static views here
